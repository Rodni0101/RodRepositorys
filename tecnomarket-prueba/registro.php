...
<body>
    <main class="auth">
        ...
        <section>
            ...
            <p>Regístrate para acceder al inventario.</p>

            <?php if ($mensaje): ?>
                <div class="mensaje <?= escapar($tipo) ?>">
                    <?= escapar($mensaje) ?>
                </div>
            <?php endif; ?>
            ...
            <form action="PHP/acciones_auth.php" method="post">
                ...
                <label>
                    Correo
                    <input type="email" name="correo" required maxlength="150" autocomplete="email">
                </label>
                ...
                <button name="accion" value="registro">Crear cuenta</button>
            </form>
